...
export let monthlyHistory: any = {
  series: [
    {
      name: "Profit",
      data: [100, 50, 25, 50, 30, 50, 70,78,62,88,90,63],
    },
    {
      name: "Revenue",
      data: [70, 20, 55, 45, 35, 110, 85,100,99,60,56,90],
    },
    
    {
      name: "Cash Flow",
      data: [85, 55, 100, 35, 90, 60, 80,90,10,12,15,80],
    },
  ],
  chart: {
    type: "bar",
  ...
  xaxis: {
    categories: ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul","Aoû","Sep","Oct","Nov","Dec"],
    floating: false,
    axisTicks: {
      show: false,
    },
